...
const ShoppingTable = () => {
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      {data.map((item, index) => (
        <Link href={`/products/151`} key={index}>
          <div className="flex items-center justify-between rounded-xl border-b border-gray-300 bg-subgray px-4 py-2 hover:bg-slate-200">
