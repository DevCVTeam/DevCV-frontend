...
//       </div>
//       <div className="flex w-full flex-col flex-wrap justify-between text-black sm:flex-row">
//         {[
//           {
//             type: 'backend',
...
//             key={type}
//             className={cn(
//               `flex cursor-pointer flex-col items-center justify-center gap-3 rounded-2xl border-4 border-white bg-white p-4 transition-all`,
